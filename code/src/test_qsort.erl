...
start() ->
    ...
    test_numeric_sort({listas, qsort1}),
    test_string_sort({listas, qsort1}),
    test_numeric_sort({listas, qsort2}),
    test_string_sort({listas, qsort2}),
    test_numeric_sort({listas, qsort3}),
    test_string_sort({listas, qsort3}),
    halt().
